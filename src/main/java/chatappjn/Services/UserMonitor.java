...
@Service
public class UserMonitor extends IdleMonitor<String> {
    @Autowired
    ...
    private final ConcurrentHashMap<String, Client> userActivityMap = new ConcurrentHashMap<>();
    ...
    @Override
    protected ConcurrentHashMap<String, Client> getActivityMap() {
      return userActivityMap;
    }

    public UUID getClientIdByUserId(String userId){
    ...
    public String getUserIdByClientId(UUID clientId){
    ...
    public void autoLogout(String userId){
      try{
